...
public class TaskUtils {
     ...
     * {@link Label}.
     */
    public static TaskInfo setOfferAttributes(TaskInfo taskInfo, Offer launchOffer) {
        String joinedAttributes = AttributeUtils.toString(launchOffer.getAttributesList());

        Labels.Builder labelsBuilder =
                removeLabel(taskInfo.getLabels(), OFFER_ATTRIBUTES_KEY).toBuilder();
        labelsBuilder.addLabelsBuilder()
    ...
    /**
     * Returns the {@link Offer} {@link Attribute}s, if any, which were embedded in the provided
     * {@link TaskInfo}.
     */
    public static List<String> getOfferAttributeStrings(TaskInfo taskInfo) {
        ...
        return AttributeUtils.toStringList(joinedAttributes);
    }
